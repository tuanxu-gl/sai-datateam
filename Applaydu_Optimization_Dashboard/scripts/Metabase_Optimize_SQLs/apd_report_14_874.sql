...
where 1=1 and server_date >= 'istart_date' and server_date < dateadd(day, 1, 'iend_date') and scan_type in ('Alternative_Vignette','Scan_Vignette','Alternative Vignette','Vignette','Scan_QR','QR Code','Toy Scan','Scan_Toy','Deep_Link')
