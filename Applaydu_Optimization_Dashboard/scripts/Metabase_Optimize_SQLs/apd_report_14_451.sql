insert into APPLAYDU_NOT_CERTIFIED.apd_report_14 
    (dashboard_id,query_id,start_date,end_date,load_time,kpi_name,value1_str,value2,value3,value4,value5,value6,value7,value8_str,value9_str)
with q451 as (select 0),
minigame_done as (
...
select 14 as dashboard_id
		...
		,"Minigame" as value1_str,"Users count" as value2,"Sessions" as value3,"Sessions per user" as value4,total_time_spent as value5,"Average time spent per game per user (minute)" as value6,"Average time spent per game per session (minute)" as value7,"Average time spent per game per user (min - sec)" as value8_str,"Average time spent per game per session (min - sec)" as value9_str
	from
	(
