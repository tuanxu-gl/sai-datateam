with r878 as(
SELECT value1 as sum_sessions_count,value2 as sum_total_time_spent,value3 as time_result,value4_str as "Time spent"
...
where start_date =  GREATEST((SELECT MIN(SERVER_DATE) FROM applaydu_not_certified.tbl_date_filter WHERE 1=1 [[AND {{idate}}]]), '2020-08-10')
	...
	and dashboard_id=14 and query_id = 878 
)
