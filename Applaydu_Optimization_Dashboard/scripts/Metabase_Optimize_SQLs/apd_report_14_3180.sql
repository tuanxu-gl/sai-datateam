insert into APPLAYDU_NOT_CERTIFIED.apd_report_14 (dashboard_id,query_id,start_date,end_date,load_time,kpi_name,dimension1,value1,value2) 
...
minigame as (
    ...
    from APPLAYDU.micro_game_triggered
    where 1=1 
...
select idashboard_id as dashboard_id
    ,iquery_id as query_id
