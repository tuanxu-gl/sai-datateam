DECLARE r319_q4231 ARRAY<STRUCT<`User Type` STRING,users INT64>>;
...
ELSE
  SET r319_q4231 = (
    SELECT ARRAY_AGG(
      STRUCT(
         CAST(value1_str as STRING) as `User Type`, CAST(value2 as INT64) as users
      )
    )
    FROM 
