DECLARE r319_q4235 ARRAY<STRUCT<feature STRING,session INT64,`Sessions per user` FLOAT64,`Time spent per user min` FLOAT64,`Session Duration` FLOAT64,`Time spent per user min - sec` STRING,`Session Duration min` STRING>>;
